...
switch (side player) do 
{
	...
	player createDiaryRecord ["Diary", ["Opposition","Enemies are east soldiers or resistance guerillas, or civilians.<br/>If the civilians have obtained weapons, they will be a formidable adversary.<br/><br/>Combat patrol objectives are present."]];
	};
	...
	player createDiaryRecord ["Diary", ["Opposition","Civilians either have weapons or they don't. Adjust accordingly. Enemies can be west, east, or resistance.<br/><br/>Combat patrol objectives are present."]];
	};
};
